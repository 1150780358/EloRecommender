...
判据:正式判据在融合层(v5_fusion F30/F31 vs F29 3.62340,ΔOOF>0.0005);单模 OOF 仅参考。
用法:ELO_SEED=777 python src/v13_gru.py data|train|all
"""
import os
import sys
import time
...
def train():
    ...
    log(f"train {xs_tr.shape} test {xs_te.shape} dev={dev}")
