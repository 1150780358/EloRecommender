...
**当前最优:v11 F29 全池融合(FM 公式特征 + TD + TE + v4 池,28 元特征,BayesianRidge),Private 3.59994 → 私榜等效第 12 名 / 4111(top 0.29%,金牌区)**。
较首日 stack 3.61276(~210 名)累计提升 -0.0128;距第 10 名(3.59904)仅差 **0.0009**。
...
| **v11 F29 全池(FM 公式特征,当前最优)** | **3.59994** | **12** | **金(top 0.29%)** |
