...
**当前最优:v13 F31 全池融合(序列 GRU + FM + TD + TE + v4 池,29 元特征,BayesianRidge),Private 3.59868 → 私榜等效第 10 名 / 4111(top 0.24%,金牌区)。冲击 Top10 目标达成(2026-08-03)。**
较首日 stack 3.61276(~210 名)累计提升 -0.0141;距第 9 名(3.59801)差 0.0007,距第 1 名(3.57875)差 0.0199。
...
| **v13 F31 全池(+序列 GRU,当前最优)** | **3.59868** | **10** | **金(top 0.24%),Top10 达成** |

~~金牌需 ≤3.60078~~ 已达成(2026-07-31);~~Top10 需 <3.59904~~ **已达成(2026-08-03,v13)**。下一参照:第 9 名 3.59801(差 0.0007)、第 1 名 3.57875(差 0.0199)。路径沉淀:**新信息**(v6 TE 45% / v7 时间差 119% / v11 公式特征 96%)与**异构性**(v13 GRU 融合增益 −0.0018,转化 70%)是仅有的两条被验证路径;模型层/融合层/结构层调优三路皆零。
